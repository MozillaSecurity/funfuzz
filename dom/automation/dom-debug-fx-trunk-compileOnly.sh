...
date
echo
echo 'This script assumes that you have an up-to-date m-central directory at ~/mozilla-central/'
echo
echo 'Starting in 7s...'
sleep 7
echo
...
echo
echo '~/fuzzing/dom/automation/how-to-use.txt - your build is located at ~/Desktop/dom-debug-fx-trunk-A/objdir-fx/dist/MinefieldDebug.app/Contents/MacOS/firefox-bin -P fuzz1-moz190'
echo
cd ~/Desktop/dom-debug-fx-trunk-A/objdir-fx/dist/MinefieldDebug.app/Contents/MacOS/
pwd
echo
#cd ~/Desktop/dom-debug-fx-trunk-A
