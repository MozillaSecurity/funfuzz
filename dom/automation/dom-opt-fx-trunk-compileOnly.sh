...
echo
echo '~/fuzzing/dom/automation/how-to-use.txt - your build is located at ~/Desktop/dom-opt-fx-trunk-A/objdir-fx/dist/Minefield.app/Contents/MacOS/firefox-bin -P fuzz1-moz190'
echo
cd ~/Desktop/dom-opt-fx-trunk-A/objdir-fx/dist/Minefield.app/Contents/MacOS/
pwd
echo
#cd ~/Desktop/dom-opt-fx-trunk-A
