var fuzzerComparePixels = (function() {
  ...
  {
    var a = [
      "var root = document.documentElement; document.removeChild(root); " + fuzzerTestingFunctions.makeCommand() + " document.appendChild(root); ",
      ...
      fuzzerTestingFunctions.makeCommand(),
