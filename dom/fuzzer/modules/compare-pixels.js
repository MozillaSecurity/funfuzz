var fuzzerComparePixels = (function() {
  ...
  {
    var a = [
      "var root = document.documentElement; document.removeChild(root); " + fuzzerTestingFunctions.makeTestingFunctionCall() + " document.appendChild(root); ",
      ...
      fuzzerTestingFunctions.makeTestingFunctionCall(),
