...
def many_timed_runs():
    ...
    while True:
        ...
        if options.fuzzjs.find("jsfunfuzz") != -1:
            # Allow abnormal exits in js shell (OOM) and xpcshell (bug 613142)
        ...
        if level > oklevel:
            ...
            if options.useCompareJIT and level == jsunhappy.JS_FINE:
                ...
                compareJIT.compareJIT(engine, jitcomparefilename, logPrefix + "-cj", knownPath, options.repo, timeout, deleteBoring=False)
